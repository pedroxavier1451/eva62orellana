...
a persistence unit "eva62orellanaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62orellana/pom.xml":
...
artifact ("eva62orellana.war") is already built. You can build
